...
import { dTOVerifyAccountGetResponseV1Schema, } from '../models/dTOVerifyAccountGetResponseV1';
import { dTOVerifyAccountInitiateResponseV1Schema, } from '../models/dTOVerifyAccountInitiateResponseV1';
import { dTOVerifyAccountInitiateResponseV2Schema, } from '../models/dTOVerifyAccountInitiateResponseV2';
import { dTOVerifyAccountListResponseV1Schema, } from '../models/dTOVerifyAccountListResponseV1';
import { dTOVerifyAccountUpdateResponseV1Schema, } from '../models/dTOVerifyAccountUpdateResponseV1';
import { dTOVerifyAccountValidateResponseV1Schema, } from '../models/dTOVerifyAccountValidateResponseV1';
import { verifyInitiateSchema } from '../models/verifyInitiate';
import { verifyUpdateSchema } from '../models/verifyUpdate';
import { verifyValidateSchema } from '../models/verifyValidate';
...
export class VerifyController extends BaseController {
     ...
     */
    async verifyAccountInitiate(body, requestOptions) {
        ...
        return req.callAsJson(dTOVerifyAccountInitiateResponseV1Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async verifyAccountUpdate(body, requestOptions) {
        ...
        req.throwOn(400, ApiError, 'Bad request');
        req.throwOn(500, ApiError, 'Internal Server Error');
        return req.callAsJson(dTOVerifyAccountUpdateResponseV1Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async verifyNPPAccountPayIdInitiate(body, requestOptions) {
        const req = this.createRequest('POST', '/verify/v2/aba/initiate');
        const mapped = req.prepareArgs({ body: [body, optional(unknown())] });
        req.json(mapped.body);
        req.throwOn(400, ApiError, 'Bad request');
        req.throwOn(500, ApiError, 'Internal Server Error');
        return req.callAsJson(dTOVerifyAccountInitiateResponseV2Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async verifyAccountValidate(body, requestOptions) {
        ...
        req.throwOn(400, ApiError, 'Bad request');
        req.throwOn(500, ApiError, 'Internal Server Error');
        return req.callAsJson(dTOVerifyAccountValidateResponseV1Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async verifyAccountList(requestOptions) {
     ...
     * @return Response from the API call
     */
    async verifyAccountGet(token, requestOptions) {
