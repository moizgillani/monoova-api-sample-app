...
import { subscriptionsCreateSchema, } from '../models/subscriptionsCreate';
import { subscriptionsCreateResponseV1Schema, } from '../models/subscriptionsCreateResponseV1';
import { subscriptionsDeleteResponseV1Schema, } from '../models/subscriptionsDeleteResponseV1';
import { subscriptionsListResponseV1Schema, } from '../models/subscriptionsListResponseV1';
import { subscriptionsReportV1Schema, } from '../models/subscriptionsReportV1';
import { subscriptionsResendResponseV1Schema, } from '../models/subscriptionsResendResponseV1';
import { subscriptionsUpdateSchema, } from '../models/subscriptionsUpdate';
import { subscriptionsUpdateResponseV1Schema, } from '../models/subscriptionsUpdateResponseV1';
...
export class SubscriptionsController extends BaseController {
     ...
     */
    async subscriptionsCreate(body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async subscriptionsList(requestOptions) {
     ...
     * @return Response from the API call
     */
    async subscriptionsResendV2(webhookId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async subscriptionsDelete(id, requestOptions) {
     ...
     * @return Response from the API call
     */
    async subscriptionsUpdate(body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async subscriptionsReport(date, skip, take, requestOptions) {
