 ...
 */
import { eventDirectEntryDishonoursWebhookSchema, } from '../models/eventDirectEntryDishonoursWebhook';
import { eventInboundDirectCreditWebhookSchema, } from '../models/eventInboundDirectCreditWebhook';
import { eventInboundDirectDebitWebhookSchema, } from '../models/eventInboundDirectDebitWebhook';
import { eventInboundRtgsImtStatusSchema, } from '../models/eventInboundRtgsImtStatus';
import { eventNppPaymentStatusWebhookSchema, } from '../models/eventNppPaymentStatusWebhook';
import { eventNppReturnWebhookSchema, } from '../models/eventNppReturnWebhook';
import { eventPayToreceivePaymentWebhookSchema, } from '../models/eventPayToreceivePaymentWebhook';
import { eventPendingrtgsImtWebhookSchema, } from '../models/eventPendingrtgsImtWebhook';
import { eventReceivePaymentWebhookSchema, } from '../models/eventReceivePaymentWebhook';
...
export class WebhooksController extends BaseController {
     ...
     */
    async receivablesReceivePaymentWebhook(authorization, verificationSignature, webhookid, body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async inboundDirectCreditWebhook(authorization, verificationSignature, webhookid, body, requestOptions) {
        const req = this.createRequest('POST', '/INBOUNDDIRECTCREDITWEBHOOK_TARGET_URL');
        const mapped = req.prepareArgs({
            authorization: [authorization, optional(string())],
            verificationSignature: [verificationSignature, optional(string())],
            webhookid: [webhookid, optional(number())],
     ...
     * @return Response from the API call
     */
    async nppPaymentStatus(authorization, verificationSignature, webhookid, body, requestOptions) {
        const req = this.createRequest('POST', '/NPPPAYMENTSTATUSWEBHOOK_TARGET_URL');
        const mapped = req.prepareArgs({
            authorization: [authorization, optional(string())],
            verificationSignature: [verificationSignature, optional(string())],
            webhookid: [webhookid, optional(number())],
     ...
     * @return Response from the API call
     */
    async payToReceivePaymentWebhook(authorization, verificationSignature, webhookid, body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async inboundDirectDebitWebhook(authorization, verificationSignature, webhookid, body, requestOptions) {
        const req = this.createRequest('POST', '/INBOUNDDIRECTDEBITWEBHOOK_TARGET_URL');
        const mapped = req.prepareArgs({
            authorization: [authorization, optional(string())],
            verificationSignature: [verificationSignature, optional(string())],
            webhookid: [webhookid, optional(number())],
     ...
     * @return Response from the API call
     */
    async directEntryDishonour(authorization, verificationSignature, webhookid, body, requestOptions) {
        const req = this.createRequest('POST', '/DIRECTENTRYDISHONOURSWEBHOOK_TARGET_URL');
        const mapped = req.prepareArgs({
            authorization: [authorization, optional(string())],
            verificationSignature: [verificationSignature, optional(string())],
            webhookid: [webhookid, optional(number())],
     ...
     * @return Response from the API call
     */
    async inboundRtgsImtStatus(authorization, verificationSignature, webhookid, body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async nppReturn(authorization, verificationSignature, webhookid, body, requestOptions) {
        const req = this.createRequest('POST', '/RECEIVENPPPAYMENTRETURN_TARGET_URL');
        const mapped = req.prepareArgs({
            authorization: [authorization, optional(string())],
            verificationSignature: [verificationSignature, optional(string())],
            webhookid: [webhookid, optional(number())],
     ...
     * @return Response from the API call
     */
    async pendingInboundRtgsImt(authorization, verificationSignature, webhookid, body, requestOptions) {
