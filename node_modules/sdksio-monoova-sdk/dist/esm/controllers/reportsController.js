...
import { dTOGenericPaymentGenericPaymentSettlementResponseV1Schema, } from '../models/dTOGenericPaymentGenericPaymentSettlementResponseV1';
import { dTOGenericPaymentGenericPaymentStatementResponseV1Schema, } from '../models/dTOGenericPaymentGenericPaymentStatementResponseV1';
...
export class ReportsController extends BaseController {
     ...
     */
    async reportSettlement(date, requestOptions) {
        ...
        return req.callAsJson(dTOGenericPaymentGenericPaymentSettlementResponseV1Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async reportStatement(date, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({ date: [date, string()] });
        req.appendTemplatePath `/reports/v1/statement/${mapped.date}`;
        req.throwOn(400, ApiError, 'Bad request');
        req.throwOn(500, ApiError, 'Internal Server Error');
        return req.callAsJson(dTOGenericPaymentGenericPaymentStatementResponseV1Schema, requestOptions);
    }
}
