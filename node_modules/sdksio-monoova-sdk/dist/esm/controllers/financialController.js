...
import { dTOGenericPaymentGatewayTransactionStatus2ResponseV2Schema, } from '../models/dTOGenericPaymentGatewayTransactionStatus2ResponseV2';
import { dTOGenericPaymentGatewayTransactionStatusResponseV2Schema, } from '../models/dTOGenericPaymentGatewayTransactionStatusResponseV2';
import { dTOGenericPaymentGatewayTransactionValidateV2Schema, } from '../models/dTOGenericPaymentGatewayTransactionValidateV2';
import { dTOGenericPaymentGenericFinanceResponseV2Schema, } from '../models/dTOGenericPaymentGenericFinanceResponseV2';
...
export class FinancialController extends BaseController {
     ...
     */
    async transactionValidate(body, requestOptions) {
        const req = this.createRequest('POST', '/financial/v2/transaction/validate');
        const mapped = req.prepareArgs({ body: [body, optional(unknown())] });
        req.json(mapped.body);
        req.throwOn(400, ApiError, 'Bad request');
        req.throwOn(500, ApiError, 'Internal Server Error');
        return req.callAsJson(dTOGenericPaymentGatewayTransactionValidateV2Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async transactionStatusByUid(uniqueReference, requestOptions) {
        ...
        req.throwOn(400, ApiError, 'Bad request');
        req.throwOn(500, ApiError, 'Internal Server Error');
        return req.callAsJson(dTOGenericPaymentGatewayTransactionStatusResponseV2Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async transactionStatusByDate(startDate, endDate, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
        ...
        req.throwOn(400, ApiError, 'Bad request');
        req.throwOn(500, ApiError, 'Internal Server Error');
        return req.callAsJson(dTOGenericPaymentGatewayTransactionStatus2ResponseV2Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async transactionExecute(body, requestOptions) {
        const req = this.createRequest('POST', '/financial/v2/transaction/execute');
        const mapped = req.prepareArgs({ body: [body, optional(unknown())] });
        req.json(mapped.body);
        req.throwOn(400, ApiError, 'Bad request');
        req.throwOn(500, ApiError, 'Internal Server Error');
        return req.callAsJson(dTOGenericPaymentGenericFinanceResponseV2Schema, requestOptions);
    }
}
