...
import { dTOPublicPingResponseV1Schema, } from '../models/dTOPublicPingResponseV1';
...
export class TestingReferenceDataController extends BaseController {
     ...
     */
    async publicCertificatePublicKey(requestOptions) {
     ...
     * @return Response from the API call
     */
    async publicPing(requestOptions) {
     ...
     * @return Response from the API call
     */
    async publicCertificate(requestOptions) {
