...
import { receivablesBatchCreateV1Schema, } from '../models/receivablesBatchCreateV1';
import { receivablesBatchStatusV1Schema, } from '../models/receivablesBatchStatusV1';
import { receivablesCreateSchema, } from '../models/receivablesCreate';
import { receivablesCreateResponseV1Schema, } from '../models/receivablesCreateResponseV1';
import { receivablesListAccountsV1Schema, } from '../models/receivablesListAccountsV1';
import { receivablesProcessdirectdebitSchema, } from '../models/receivablesProcessdirectdebit';
import { receivablesProcessDirectDebitResponseV1Schema, } from '../models/receivablesProcessDirectDebitResponseV1';
import { receivablesProcessrtgsimtSchema, } from '../models/receivablesProcessrtgsimt';
import { receivablesRefundSchema, } from '../models/receivablesRefund';
import { receivablesRefundResponseV1Schema, } from '../models/receivablesRefundResponseV1';
import { receivablesReportLastSettlementV1Schema, } from '../models/receivablesReportLastSettlementV1';
import { receivablesStatusSchema, } from '../models/receivablesStatus';
import { receivablesStatusGetResponseV1Schema, } from '../models/receivablesStatusGetResponseV1';
import { receivablesStatusSetResponseV1Schema, } from '../models/receivablesStatusSetResponseV1';
import { transactionCodeEnumSchema, } from '../models/transactionCodeEnum';
import { transactionTypeEnumSchema, } from '../models/transactionTypeEnum';
...
export class AutomatcherBankAccountReceivablesController extends BaseController {
     ...
     */
    async receivablesCreate(body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async receivablesStatus(body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async receivablesInboundDirectDebitReportDate(date, requestOptions) {
     ...
     * @return Response from the API call
     */
    async receivablesReportDate(date, endDate, skip, take, accountNumber, clientUniqueId, transactionType, transactionCode, payId, payIdName, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
            date: [date, string()],
     ...
     * @return Response from the API call
     */
    async payToReceivablesReportDate(date, endDate, skip, take, accountNumber, clientUniqueId, transactionType, transactionCode, payId, payIdName, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
            date: [date, string()],
            endDate: [endDate, optional(string())],
     ...
     * @return Response from the API call
     */
    async receivablesBatchCreate(body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async receivablesbatchStatus(body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async receivablesListAccounts(requestOptions) {
     ...
     * @return Response from the API call
     */
    async receivablesRefund(body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async receivablesProcessDirectDebit(body, requestOptions) {
        const req = this.createRequest('POST', '/receivables/v1/processdirectdebit');
        const mapped = req.prepareArgs({
        ...
        req.throwOn(400, ApiError, 'Bad request');
        req.throwOn(500, ApiError, 'Internal Server Error');
        return req.callAsJson(receivablesProcessDirectDebitResponseV1Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async receivablesProcessRtgsImt(body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async receivablesRTGSIMTReportDate(date, endDate, skip, take, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
            date: [date, string()],
            endDate: [endDate, optional(string())],
     ...
     * @return Response from the API call
     */
    async receivablesStatusByBank(bankAccountNumber, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
     ...
     * @return Response from the API call
     */
    async receivablesStatusByClientID(clientUniqueId, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
     ...
     * @return Response from the API call
     */
    async receivablesReportLastSettlement(requestOptions) {
        const req = this.createRequest('GET', '/receivables/v1/reportLastSettlement');
        req.throwOn(400, ApiError, 'Bad request');
        req.throwOn(500, ApiError, 'Internal Server Error');
        return req.callAsJson(receivablesReportLastSettlementV1Schema, requestOptions);
    }
}
