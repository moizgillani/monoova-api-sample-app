...
import { receivablesCreateWhiteListingAccountSchema, } from '../models/receivablesCreateWhiteListingAccount';
import { receivablesCreateWhiteListingAccountResponseV1Schema, } from '../models/receivablesCreateWhiteListingAccountResponseV1';
import { receivablesGetWhiteListingAccountsResponseV1Schema, } from '../models/receivablesGetWhiteListingAccountsResponseV1';
import { receivablesUpdateWhiteListingAccountSchema, } from '../models/receivablesUpdateWhiteListingAccount';
import { receivablesUpdateWhiteListingAccountResponseV1Schema, } from '../models/receivablesUpdateWhiteListingAccountResponseV1';
...
export class WhitelistingForAutomatcherBankAccountReceivablesController extends BaseController {
     ...
     */
    async receivablesListWhitelistSourceAccounts(automatcherBankAccountNumber, requestOptions) {
        ...
        return req.callAsJson(receivablesGetWhiteListingAccountsResponseV1Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async receivablesCreateWhitelistSourceAccount(body, requestOptions) {
        const req = this.createRequest('POST', '/receivables/v1/whitelisting/create');
        const mapped = req.prepareArgs({
        ...
        req.throwOn(400, ApiError, 'Bad request');
        req.throwOn(500, ApiError, 'Internal Server Error');
        return req.callAsJson(receivablesCreateWhiteListingAccountResponseV1Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async receivablesUpdateWhitelistSourceAccount(body, requestOptions) {
        const req = this.createRequest('POST', '/receivables/v1/whitelisting/update');
        const mapped = req.prepareArgs({
        ...
        req.throwOn(400, ApiError, 'Bad request');
        req.throwOn(500, ApiError, 'Internal Server Error');
        return req.callAsJson(receivablesUpdateWhiteListingAccountResponseV1Schema, requestOptions);
    }
    /**
     ...
     * @return Response from the API call
     */
    async receivablesRejectedTransactionsReport(date, requestOptions) {
        const req = this.createRequest('GET');
