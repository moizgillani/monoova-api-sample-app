...
import { dTOToolsAbnValidateResponseV1Schema, } from '../models/dTOToolsAbnValidateResponseV1';
import { dTOToolsBsbValidateResponseV1Schema, } from '../models/dTOToolsBsbValidateResponseV1';
import { dTOToolsPingResponseV1Schema, } from '../models/dTOToolsPingResponseV1';
import { dTOToolsSendEmailResponseV1Schema, } from '../models/dTOToolsSendEmailResponseV1';
import { toolsSendEmailToIssuerSchema, } from '../models/toolsSendEmailToIssuer';
...
export class ToolsController extends BaseController {
     ...
     */
    async toolsPing(requestOptions) {
     ...
     * @return Response from the API call
     */
    async toolsSendEmailToIssuer(body, requestOptions) {
     ...
     * @return Response from the API call
     */
    async toolsBsbValidate(bsbNumber, requestOptions) {
     ...
     * @return Response from the API call
     */
    async toolsAbnValidate(abnNumber, requestOptions) {
        const req = this.createRequest('GET');
