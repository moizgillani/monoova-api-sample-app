...
import { dTOBPAYBillerResponseV1Schema, } from '../models/dTOBPAYBillerResponseV1';
import { dTOBPAYBillersResponseV1Schema, } from '../models/dTOBPAYBillersResponseV1';
import { dTOBPAYHistoryResponseV1Schema, } from '../models/dTOBPAYHistoryResponseV1';
import { dTOBPAYReceiptResponseV1Schema, } from '../models/dTOBPAYReceiptResponseV1';
import { dTOValidateBPAYResponseV1Schema, } from '../models/dTOValidateBPAYResponseV1';
...
export class BPAYController extends BaseController {
     ...
     */
    async bPAYReceivablesReport(date, skip, take, requestOptions) {
     ...
     * @return Response from the API call
     */
    async bPAYValidate(billerCode, custRef, amount, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
     ...
     * @return Response from the API call
     */
    async bPAYGetBiller(billerCode, requestOptions) {
        const req = this.createRequest('GET');
     ...
     * @return Response from the API call
     */
    async bPAYGetReceipts(requestOptions) {
     ...
     * @return Response from the API call
     */
    async bPAYGetBillers(search, skip, take, requestOptions) {
     ...
     * @return Response from the API call
     */
    async bPAYGetHistory(accountNumber, take, requestOptions) {
        const req = this.createRequest('GET');
        const mapped = req.prepareArgs({
