...
export class Client {
    constructor(config) {
        ...
        this._requestBuilderFactory = createRequestHandlerFactory(server => getBaseUri(server, this._config), basicAuthenticationProvider(this._config.basicAuthUserName, this._config.basicAuthPassword), new HttpClient(AbortError, {
