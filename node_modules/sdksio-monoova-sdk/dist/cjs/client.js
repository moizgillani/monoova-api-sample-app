...
var Client = /** @class */ (function () {
    function Client(config) {
        ...
        this._requestBuilderFactory = createRequestHandlerFactory(function (server) { return getBaseUri(server, _this._config); }, (0, authentication_1.basicAuthenticationProvider)(this._config.basicAuthUserName, this._config.basicAuthPassword), new clientAdapter_1.HttpClient(core_2.AbortError, {
...
function getBaseUri(server, config) {
    ...
    if (config.environment === configuration_1.Environment.Production) {
        if (server === 'default') {
            return 'https://api.mpay.com.au';
        }
    }
    if (config.environment === configuration_1.Environment.Environment2) {
        if (server === 'default') {
            return 'https://api.m-pay.com.au';
        }
    }
