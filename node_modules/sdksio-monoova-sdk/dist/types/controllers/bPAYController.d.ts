...
import { DTOBPAYBillerResponseV1 } from '../models/dTOBPAYBillerResponseV1';
import { DTOBPAYBillersResponseV1 } from '../models/dTOBPAYBillersResponseV1';
import { DTOBPAYHistoryResponseV1 } from '../models/dTOBPAYHistoryResponseV1';
import { DTOBPAYReceiptResponseV1 } from '../models/dTOBPAYReceiptResponseV1';
import { DTOValidateBPAYResponseV1 } from '../models/dTOValidateBPAYResponseV1';
import { BaseController } from './baseController';
export declare class BPAYController extends BaseController {
    /**
     ...
     */
    bPAYReceivablesReport(date: string, skip?: number, take?: number, requestOptions?: RequestOptions): Promise<ApiResponse<unknown>>;
    /**
     ...
     * @return Response from the API call
     */
    bPAYValidate(billerCode: string, custRef?: string, amount?: number, requestOptions?: RequestOptions): Promise<ApiResponse<DTOValidateBPAYResponseV1>>;
    /**
     ...
     * @return Response from the API call
     */
    bPAYGetBiller(billerCode: string, requestOptions?: RequestOptions): Promise<ApiResponse<DTOBPAYBillerResponseV1>>;
    /**
     ...
     * @return Response from the API call
     */
    bPAYGetReceipts(requestOptions?: RequestOptions): Promise<ApiResponse<DTOBPAYReceiptResponseV1>>;
    /**
     ...
     * @return Response from the API call
     */
    bPAYGetBillers(search?: string, skip?: number, take?: number, requestOptions?: RequestOptions): Promise<ApiResponse<DTOBPAYBillersResponseV1>>;
    /**
     ...
     * @return Response from the API call
     */
    bPAYGetHistory(accountNumber: bigint, take?: number, requestOptions?: RequestOptions): Promise<ApiResponse<DTOBPAYHistoryResponseV1>>;
}
