...
import { DTOGenericPaymentGatewayTransactionStatus2ResponseV2 } from '../models/dTOGenericPaymentGatewayTransactionStatus2ResponseV2';
import { DTOGenericPaymentGatewayTransactionStatusResponseV2 } from '../models/dTOGenericPaymentGatewayTransactionStatusResponseV2';
import { DTOGenericPaymentGatewayTransactionValidateV2 } from '../models/dTOGenericPaymentGatewayTransactionValidateV2';
import { DTOGenericPaymentGenericFinanceResponseV2 } from '../models/dTOGenericPaymentGenericFinanceResponseV2';
import { BaseController } from './baseController';
export declare class FinancialController extends BaseController {
    /**
     ...
     */
    transactionValidate(body?: unknown, requestOptions?: RequestOptions): Promise<ApiResponse<DTOGenericPaymentGatewayTransactionValidateV2>>;
    /**
     ...
     * @return Response from the API call
     */
    transactionStatusByUid(uniqueReference: string, requestOptions?: RequestOptions): Promise<ApiResponse<DTOGenericPaymentGatewayTransactionStatusResponseV2>>;
    /**
     ...
     * @return Response from the API call
     */
    transactionStatusByDate(startDate: string, endDate: string, requestOptions?: RequestOptions): Promise<ApiResponse<DTOGenericPaymentGatewayTransactionStatus2ResponseV2>>;
    /**
     ...
     * @return Response from the API call
     */
    transactionExecute(body?: unknown, requestOptions?: RequestOptions): Promise<ApiResponse<DTOGenericPaymentGenericFinanceResponseV2>>;
}
