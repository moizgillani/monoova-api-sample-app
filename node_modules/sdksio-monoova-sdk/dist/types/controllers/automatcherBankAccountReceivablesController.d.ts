...
import { ReceivablesBatchCreateV1 } from '../models/receivablesBatchCreateV1';
import { ReceivablesBatchStatusV1 } from '../models/receivablesBatchStatusV1';
import { ReceivablesCreate } from '../models/receivablesCreate';
import { ReceivablesCreateResponseV1 } from '../models/receivablesCreateResponseV1';
import { ReceivablesListAccountsV1 } from '../models/receivablesListAccountsV1';
import { ReceivablesProcessdirectdebit } from '../models/receivablesProcessdirectdebit';
import { ReceivablesProcessDirectDebitResponseV1 } from '../models/receivablesProcessDirectDebitResponseV1';
import { ReceivablesProcessrtgsimt } from '../models/receivablesProcessrtgsimt';
import { ReceivablesRefund } from '../models/receivablesRefund';
import { ReceivablesRefundResponseV1 } from '../models/receivablesRefundResponseV1';
import { ReceivablesReportLastSettlementV1 } from '../models/receivablesReportLastSettlementV1';
import { ReceivablesStatus } from '../models/receivablesStatus';
import { ReceivablesStatusGetResponseV1 } from '../models/receivablesStatusGetResponseV1';
import { ReceivablesStatusSetResponseV1 } from '../models/receivablesStatusSetResponseV1';
import { TransactionCodeEnum } from '../models/transactionCodeEnum';
import { TransactionTypeEnum } from '../models/transactionTypeEnum';
import { BaseController } from './baseController';
export declare class AutomatcherBankAccountReceivablesController extends BaseController {
    /**
     ...
     */
    receivablesCreate(body?: ReceivablesCreate, requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesCreateResponseV1>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesStatus(body?: ReceivablesStatus, requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesStatusSetResponseV1>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesInboundDirectDebitReportDate(date: string, requestOptions?: RequestOptions): Promise<ApiResponse<unknown>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesReportDate(date: string, endDate?: string, skip?: number, take?: number, accountNumber?: number, clientUniqueId?: string, transactionType?: TransactionTypeEnum, transactionCode?: TransactionCodeEnum, payId?: string, payIdName?: string, requestOptions?: RequestOptions): Promise<ApiResponse<unknown>>;
    /**
     ...
     * @return Response from the API call
     */
    payToReceivablesReportDate(date: string, endDate?: string, skip?: number, take?: number, accountNumber?: number, clientUniqueId?: string, transactionType?: TransactionTypeEnum, transactionCode?: TransactionCodeEnum, payId?: string, payIdName?: string, requestOptions?: RequestOptions): Promise<ApiResponse<unknown>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesBatchCreate(body?: FileWrapper, requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesBatchCreateV1>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesbatchStatus(body?: FileWrapper, requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesBatchStatusV1>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesListAccounts(requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesListAccountsV1>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesRefund(body?: ReceivablesRefund, requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesRefundResponseV1>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesProcessDirectDebit(body?: ReceivablesProcessdirectdebit, requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesProcessDirectDebitResponseV1>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesProcessRtgsImt(body?: ReceivablesProcessrtgsimt, requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesProcessDirectDebitResponseV1>>;
    /**
     * Returns a report of all received transactions for the day with associated details, this includes
     ...
     * @return Response from the API call
     */
    receivablesRTGSIMTReportDate(date: string, endDate?: string, skip?: number, take?: number, requestOptions?: RequestOptions): Promise<ApiResponse<unknown>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesStatusByBank(bankAccountNumber: number, requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesStatusGetResponseV1>>;
    /**
     * Returns the status of a bank account number. Without changing the status, this API is used for
     * checking the status of a bank account. Status can be called using either bankAccount number or
     * clientUniqueId.
     ...
     * @return Response from the API call
     */
    receivablesStatusByClientID(clientUniqueId: string, requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesStatusGetResponseV1>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesReportLastSettlement(requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesReportLastSettlementV1>>;
}
