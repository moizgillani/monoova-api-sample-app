...
import { ReceivablesCreateWhiteListingAccount } from '../models/receivablesCreateWhiteListingAccount';
import { ReceivablesCreateWhiteListingAccountResponseV1 } from '../models/receivablesCreateWhiteListingAccountResponseV1';
import { ReceivablesGetWhiteListingAccountsResponseV1 } from '../models/receivablesGetWhiteListingAccountsResponseV1';
import { ReceivablesUpdateWhiteListingAccount } from '../models/receivablesUpdateWhiteListingAccount';
import { ReceivablesUpdateWhiteListingAccountResponseV1 } from '../models/receivablesUpdateWhiteListingAccountResponseV1';
import { BaseController } from './baseController';
export declare class WhitelistingForAutomatcherBankAccountReceivablesController extends BaseController {
    /**
     ...
     */
    receivablesListWhitelistSourceAccounts(automatcherBankAccountNumber: number, requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesGetWhiteListingAccountsResponseV1>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesCreateWhitelistSourceAccount(body?: ReceivablesCreateWhiteListingAccount, requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesCreateWhiteListingAccountResponseV1>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesUpdateWhitelistSourceAccount(body?: ReceivablesUpdateWhiteListingAccount, requestOptions?: RequestOptions): Promise<ApiResponse<ReceivablesUpdateWhiteListingAccountResponseV1>>;
    /**
     ...
     * @return Response from the API call
     */
    receivablesRejectedTransactionsReport(date: string, requestOptions?: RequestOptions): Promise<ApiResponse<unknown>>;
}
